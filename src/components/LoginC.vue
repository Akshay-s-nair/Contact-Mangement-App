      ...
      <div class="formBody">
        ...
        <form @submit.prevent="handleLogin">
          ...
          <div class="form-group">
            ...
            <router-link class="LRLinks" to="/forgot">Forgot Password?</router-link>
          </div>
          <div class="error-div">
        ...
        <div class="registerFromLogin">
          <p>Don't have an account? <router-link class="LRLinks"  style="color:#da5b01;" to="/register">Signup</router-link></p>
        </div>
      </div>
    </div>
  </div>
